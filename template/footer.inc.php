<footer class="r-footer">
  <div class="container r-footer__inner">
    ...
    <!-- start opening hours -->
    <div class="r-footer__opening-hours">
      <p><strong>Openingsuren</strong></p>
      Maandag gesloten<br>
      Dinsdag gesloten<br>
      Do-Woe: 7h30 - 18h00<br>
      Vrij-Za: 7h30 - 14h00<br>
      Zon: 7h30 - 13h00<br>
    </div>
    <!-- end opening hours -->
    ...
    <div class="r-footer__contact">
      ...
      <a class="c-phone c-phone--accent" href="tel:+3214811260">014/811260</a>
    </div>
    <!-- end Contact information -->

    <!-- start Facebook region  -->
